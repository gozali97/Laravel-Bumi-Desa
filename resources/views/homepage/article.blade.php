<div class="container-lg p-5">
   <div class="row">
      ...
      <div class="col-6 text-end">
         <a href="https://blog.bumdes.id/" class="link-success text-decoration-none">Lihat semua <i class="fa-solid fa-arrow-right"></i></a>
      </div>
            ...
            <a href="{{  $article['link']  }}" class="text-decoration-none link-dark" target="_blank">
               <div class="card card-body rounded-5 h-100 border-0 shadow">
                  <div class="overflow-hidden rounded-5">
                     <!-- gambar artikel -->
                     <img src="{{ $article['jetpack_featured_media_url'] }}" alt="" class="img-fluid w-100">
                  </div>
                  <!-- judul artikel -->
