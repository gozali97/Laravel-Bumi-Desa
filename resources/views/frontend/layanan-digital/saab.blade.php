         ...
         <div class="container py-5">
            <div class="row align-items-center">
               <div class="col-md-6 col-lg-5 order-1 order-md-0">
                  ...
                  <p class="small text-secondary m-0 p-0">Setiap catatan traksaksi penerimaan, pengeluaran dan Laporan SPJ harus dibuat serinci mungkin, Aplikasi SAAB akan membantu
                     membuat laporan menjadi lebih mudah.</p>
               </div>
