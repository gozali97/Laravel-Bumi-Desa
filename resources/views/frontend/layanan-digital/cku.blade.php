   ...
   <section id="cku">
            ...
            <div class="row">
               <div class="col-lg-6 order-lg-0 small order-1">
                  ...
                  <div class="d-flex align-items-center mt-3">
                     <a href="{{ Auth::guest() ? url('login') : 'https://superapps.syncore.id/cku' }}" class="btn btn-lightgreen btn-sm me-2 rounded-3 py-2 px-3">Coba sekarang</a>
      ...
      <div class="bg-fa" id="layanan-digital-lainnya">
         <div class="container py-5">
            <div class="row">
               <div class="col">
                  <h3 class="mb-3 ps-5" style="line-height: 40px; font-weight: 600;">Dapatkan Layanan digital lainnya</h3>
                  <div id="slider-owl">
                     <div class="owl-carousel owl-theme px-5 py-3">
                        ...
                        <div class="card rounded-5 h-100 p-2 shadow-sm">
                           ...
                           <div class="card-body small">
                              <h6 class="card-text" style="font-weight: 600">Halo Desa</h6>
                        ...
                        <div class="card rounded-5 h-100 p-2 shadow-sm">
                           ...
                           <div class="card-body small">
                              <h6 class="card-text" style="font-weight: 600">Cek Kesehatan Usaha BUMDES (CKU-B)</h6>
                        ...
                        <div class="card rounded-5 h-100 p-2 shadow-sm">
                           ...
                           <div class="card-body small">
                              <h6 class="card-text" style="font-weight: 600">Tanya Bumdes</h6>
