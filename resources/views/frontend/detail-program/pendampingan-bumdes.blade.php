                  ...
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                     <div class="card rounded-4 position-relative h-100 border-0 p-2">
                        ...
                        <div class="unggulan position-absolute">
                            @if($mentorship->featured == 1)
                           <img src="{{ asset('/assets/home/img/program/label-unggulan.svg') }}" alt="label pendampingan unggulan" class="img-fluid">
                           @endif
                        </div>
                        <div class="rounded-4 overflow-hidden">
                           <img src="{{asset('images/mentorship/image/' .$mentorship->image)}}" alt="{{ $mentorship->title}}" class="img-fluid w-100">
                        </div>
                        <div class="card-body list-pelatihan my-0">
                           <p class="m-0 p-0" style="font-weight: 600">{{ $mentorship->title }}</p>
                        </div>
                 ...
                 @foreach ($alumnaes as $alumnae)
                     <div class="row align-items-center justify-content-md-center">
                        <div class="col-3 col-md-5 col-lg-3 mb-md-2">
                           <!-- foto user -->
                           <img src="{{asset('images/mentorship/alumnae/' .$alumnae->image)}}" alt="" class="rounded-circle" style="width: 100%">
                        </div>
                        <div class="col-9 col-md-12 col-lg-9 small">
                           <!-- nama user -->
                           <p class="fw-bold text-md-center text-lg-start my-0">{{ $alumnae->alumnae_name }}</p>
                           <p class="small text-secondary text-md-center text-lg-start my-0">{{ $alumnae->institution }}</p>
                        </div>
                        <div class="col-12 small my-3">
                           <!-- teks testimoni -->
                           <p class="small my-0">{!! $alumnae->description !!}</p>
                        </div>
                     </div>
                  @endforeach
               </div>
                  ...
                  <div class="accordion small mb-2" id="accordionFaqSatu">
                     <div class="accordion-item rounded-5">
                        <h6 class="small accordion-header">
                           <button class="accordion-button small bg-transparent" data-bs-slide-to="{{ $i }} type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriSatu">
                              {{$program->question}}
                           </button>
                        </h6>
