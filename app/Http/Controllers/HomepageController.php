...
class HomepageController extends Controller
{
    ...
    public function index()
    {
        ...
        $profile = Profile::orderBy('id', 'desc')->paginate(20);

        $videoList = Youtube::listChannelVideos('UCQ2KPnmz9-gocPuNnK4xOGQ', 50);
        // dd($videoList);
        return view('homepage.index')->with([
            'banners' => $banners, 'articles' => $articles, 'videoList' => $videoList,
            'categoryPrograms' => $categoryPrograms, 'produk' => $produk, 'profile' => $profile, 'newslatters' => $newslatters
        ]);
    }
